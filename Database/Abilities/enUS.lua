...
[71] = {name = "Defensive Stance", description = "[q]A defensive combat stance. Decreases damage taken by 10% and damage caused by 10%. Increases threat generated."},
[72] = {name = "Shield Bash", description = "[q]Bashes the target with your shield for 6 damage. It also interrupts spellcasting and prevents any spell in that school from being cast for 6 sec."},
...
[118] = {name = "Polymorph", description = "[q]Transforms the enemy into a sheep, forcing it to wander around for up to 20 sec. While wandering, the sheep cannot attack or cast spells but will regenerate very quickly. Any damage will transform the target back into its normal form. Only one target can be polymorphed at a time. Only works on Beasts, Humanoids and Critters."},
[122] = {name = "Frost Nova", description = "[q]Blasts enemies near the caster for [19 * ( 1 ) ] to [21 * ( 1 ) ] Frost damage and freezes them in place for up to 8 sec. Damage caused may interrupt the effect."},
[133] = {name = "Fireball", description = "[q]Hurls a fiery ball that causes 16 to 25 Fire damage and an additional 2 Fire damage over 4 sec."},
...
[139] = {name = "Renew", description = "[q]Heals the target of 45 damage over 15 sec."},
[145] = {name = "Fireball", description = "[q]Hurls a fiery ball that causes 57 to 77 Fire damage and an additional 6 Fire damage over 6 sec."},
[172] = {name = "Corruption", description = "[q]Corrupts the target, causing 40 Shadow damage over 12 sec."},
...
[324] = {name = "Lightning Shield", description = "[q]The caster is surrounded by 3 balls of lightning. When a spell, melee or ranged attack hits the caster, the attacker will be struck for 13 Nature damage. This expends one lightning ball. Only one ball will fire every few seconds. Lasts 10 min."},
[325] = {name = "Lightning Shield", description = "[q]The caster is surrounded by 3 balls of lightning. When a spell, melee or ranged attack hits the caster, the attacker will be struck for 29 Nature damage. This expends one lightning ball. Only one ball will fire every few seconds. Lasts 10 min."},
[332] = {name = "Healing Wave", description = "[q]Heals a friendly target for 69 to 83."},
[348] = {name = "Immolate", description = "[q]Burns the enemy for [ 11 * ( ( ( 1 ) ) ) ] Fire damage and then an additional 20 Fire damage over 15 sec."},
[355] = {name = "Taunt", description = "[q]Taunts the target to attack you, but has no effect if the target is already attacking you."},
[370] = {name = "Purge", description = "[q]Purges the enemy target, removing 1 magic effect."},
[421] = {name = "Chain Lightning", description = "[q]Hurls a lightning bolt at the enemy, dealing 200 to 227 Nature damage and then jumping to additional nearby enemies. Each jump reduces the damage by 30% . Affects 3 total targets."},
[465] = {name = "Devotion Aura", description = "[q]Gives 55 additional armor to party members within 30 yards. Players may only have one Aura on them per Paladin at any one time."},
[467] = {name = "Thorns", description = "[q]Thorns sprout from the friendly target causing 3 Nature damage to attackers when hit. Lasts 10 min."},
...
[527] = {name = "Dispel Magic", description = "[q]Dispels magic on the target, removing 1 harmful spell from a friend or 1 beneficial spell from an enemy."},
[547] = {name = "Healing Wave", description = "[q]Heals a friendly target for 136 to 163."},
[568] = {name = "Arcane Burst", description = "Movement speed reduced by 70%."},
[588] = {name = "Inner Fire", description = "[q]A burst of Holy energy fills the caster, increasing armor by 315. Each melee or ranged damage hit against the priest will remove one charge. Lasts 10 min or until 20 charges are used."},
[589] = {name = "Shadow Word: Pain", description = "[q]A word of darkness that causes 30 Shadow damage over 18 sec."},
[591] = {name = "Smite", description = "[q]Smite an enemy for 28 to 34 Holy damage."},
[594] = {name = "Shadow Word: Pain", description = "[q]A word of darkness that causes 66 Shadow damage over 18 sec."},
[600] = {name = "Power Word: Shield", description = "[q]Draws on the soul of the party member to shield them, absorbing 166 damage. Lasts 30 sec. While the shield holds, spellcasting will not be interrupted by damage. Once shielded, the target cannot be shielded again for 15 sec."},
[642] = {name = "Divine Shield", description = "[q]Protects the paladin from all damage and spells for 10 sec, but\n\nS03 - Tuning and Overrides Passive - Paladin\nreduces all damage you deal by 50%\n\n increases the time between your attacks by 100%. Once protected, the target cannot be made invulnerable by Divine Shield, Divine Protection or Blessing of Protection again for 1 min."},
[643] = {name = "Devotion Aura", description = "[q]Gives 275 additional armor to party members within 30 yards. Players may only have one Aura on them per Paladin at any one time."},
[674] = {name = "Dual Wield", description = "[q]Allows one-hand and off-hand weapons to be equipped in the off-hand."},
[676] = {name = "Disarm", description = "[q]Disarm the enemy's weapon for 10 sec."},
[688] = {name = "Summon Imp", description = "[q]Summons an Imp under the command of the Warlock."},
[689] = {name = "Drain Life", description = "[q]Transfers 10 health every second from the target to the caster. Lasts 5 sec."},
[696] = {name = "Demon Skin", description = "[q]Protects the caster, increasing armor by 120 and restores 5 Health per 5 sec. for 30 min."},
[700] = {name = "Sleep", description = "[q]Puts the enemy target to sleep for up to 20 sec. Any damage caused will awaken the target. Only one target can be asleep at a time."},
[702] = {name = "Curse of Weakness", description = "[q]Damage caused by the target is reduced by 3 for 2 min. Only one Curse per Warlock can be active on any one target."},
[706] = {name = "Demon Armor", description = "[q]Protects the caster, increasing armor by 210, Shadow resistance by 3 and restores 7 health every 5 sec. for 30 min."},
[707] = {name = "Immolate", description = "[q]Burns the enemy for [ 24 * ( ( ( 1 ) ) ) ] Fire damage and then an additional 40 Fire damage over 15 sec."},
...
[774] = {name = "Rejuvenation", description = "[q]Heals the target for 32 over 12 sec."},
[782] = {name = "Thorns", description = "[q]Thorns sprout from the friendly target causing 6 Nature damage to attackers when hit. Lasts 10 min."},
...
[845] = {name = "Cleave", description = "[q]A sweeping attack that does your weapon damage plus 5 to the target and his nearest ally."},
...
[865] = {name = "Frost Nova", description = "[q]Blasts enemies near the caster for [33 * ( 1 ) ] to [37 * ( 1 ) ] Frost damage and freezes them in place for up to 8 sec. Damage caused may interrupt the effect."},
[894] = {name = "Blink", description = "[q]Teaches Blink (Rank 2)."},
[913] = {name = "Healing Wave", description = "[q]Heals a friendly target for 279 to 328."},
[939] = {name = "Healing Wave", description = "[q]Heals a friendly target for 389 to 454."},
[945] = {name = "Lightning Shield", description = "[q]The caster is surrounded by 3 balls of lightning. When a spell, melee or ranged attack hits the caster, the attacker will be struck for 80 Nature damage. This expends one lightning ball. Only one ball will fire every few seconds. Lasts 10 min."},
[959] = {name = "Healing Wave", description = "[q]Heals a friendly target for 552 to 639."},
[970] = {name = "Shadow Word: Pain", description = "[q]A word of darkness that causes 132 Shadow damage over 18 sec."},
[980] = {name = "Curse of Agony", description = "[q]Curses the target with agony, causing 84 Shadow damage over 24 sec. This damage is dealt slowly at first, and builds up as the Curse reaches its full duration. Only one Curse per Warlock can be active on any one target."},
[984] = {name = "Smite", description = "[q]Smite an enemy for 97 to 112 Holy damage."},
[992] = {name = "Shadow Word: Pain", description = "[q]A word of darkness that causes 234 Shadow damage over 18 sec."},
[1006] = {name = "Inner Fire", description = "[q]A burst of Holy energy fills the caster, increasing armor by 945. Each melee or ranged damage hit against the priest will remove one charge. Lasts 10 min or until 20 charges are used."},
[1010] = {name = "Curse of Idiocy", description = "[q]Curse the target with idiocy, reducing Intellect and Spirit by 6 every 3 seconds until each is reduced by a total of 90. Only one Curse per Warlock can be active on any one target."},
[1020] = {name = "Divine Shield", description = "[q]Protects the paladin from all damage and spells for 12 sec, but\n\nS03 - Tuning and Overrides Passive - Paladin\nreduces all damage you deal by 50%\n\n increases the time between your attacks by 100%. Once protected, the target cannot be made invulnerable by Divine Shield, Divine Protection or Blessing of Protection again for 1 min."},
[1026] = {name = "Holy Light", description = "[q]Heals a friendly target for 322 to 368."},
[1032] = {name = "Devotion Aura", description = "[q]Gives 505 additional armor to party members within 30 yards. Players may only have one Aura on them per Paladin at any one time."},
[1058] = {name = "Rejuvenation", description = "[q]Heals the target for 56 over 12 sec."},
[1094] = {name = "Immolate", description = "[q]Burns the enemy for [ 53 * ( ( ( 1 ) ) ) ] Fire damage and then an additional 90 Fire damage over 15 sec."},
[1096] = {name = "Firebolt IV", description = "[q]Blasts a target for 42 to 49 Fire damage."},
[1106] = {name = "Shadow Bolt", description = "[q]Sends a shadowy bolt at the enemy, causing 150 to 170 Shadow damage."},
[1211] = {name = "Frostbolt", description = nil},
[1243] = {name = "Power Word: Fortitude", description = "[q]Power infuses the target, increasing their Stamina by 3 for 30 min."},
[1245] = {name = "Power Word: Fortitude", description = "[q]Power infuses the target, increasing their Stamina by 20 for 30 min."},
[1430] = {name = "Rejuvenation", description = "[q]Heals the target for 116 over 12 sec."},
[1461] = {name = "Arcane Intellect", description = "[q]Increases the target's Intellect by 15 for 30 min."},
...
[1671] = {name = "Shield Bash", description = "[q]Bashes the target with your shield for 18 damage. It also interrupts spellcasting and prevents any spell in that school from being cast for 6 sec."},
...
[1714] = {name = "Curse of Tongues", description = "[q]Forces the target to speak in Demonic, slowing the casting time of all spells by 50%. Only one Curse per Warlock can be active on any one target. Lasts 30 sec."},
[1758] = {name = "Sinister Strike", description = "[q]An instant strike that causes 10 damage in addition to your normal weapon damage. Awards 1 combo point."},
[1766] = {name = "Kick", description = "[q]A quick kick that injures a single foe for 15 damage. It also interrupts spellcasting and prevents any spell in that school from being cast for 5 sec."},
[1776] = {name = "Gouge", description = "[q]Causes 10 damage, incapacitating the opponent for 4 sec, and turns off your attack. Target must be facing you. Any damage caused will revive the target. Awards 1 combo point."},
[1777] = {name = "Gouge", description = "[q]Causes 20 damage, incapacitating the opponent for 4 sec, and turns off your attack. Target must be facing you. Any damage caused will revive the target. Awards 1 combo point."},
[1822] = {name = "Rake", description = "[q]Rake the target for 19 damage and an additional 39 damage over 9 sec. Awards 1 combo point."},
...
[2052] = {name = "Lesser Heal", description = "[q]Heal your target for 76 to 91."},
[2053] = {name = "Lesser Heal", description = "[q]Heal your target for 143 to 165."},
[2054] = {name = "Heal", description = "[q]Heal your target for 307 to 353."},
[2055] = {name = "Heal", description = "[q]Heal your target for 445 to 507."},
[2091] = {name = "Rejuvenation", description = "[q]Heals the target for 244 over 12 sec."},
[2121] = {name = "Flamestrike", description = "[q]Calls down a pillar of fire, burning all enemies within the area for 100 to 126 Fire damage and an additional 88 Fire damage over 8 sec."},
[2136] = {name = "Fire Blast", description = "[q]Blasts the enemy for 27 to 35 Fire damage."},
[2138] = {name = "Fire Blast", description = "[q]Blasts the enemy for 110 to 134 Fire damage."},
[2174] = {name = "Pattern: White Leather Jerkin", description = "[q]Teaches you how to craft a White Leather Jerkin."},
[2484] = {name = "Earthbind Totem", description = "[q]Summons an Earthbind Totem with 5 health at the feet of the caster for 45 sec that slows the movement speed of enemies within 10 yards."},
[2589] = {name = "Backstab", description = "[q]Backstab the target, causing 150% weapon damage plus 30 to the target. Must be behind the target. Requires a dagger in the main hand. Awards 1 combo point."},
[2590] = {name = "Backstab", description = "[q]Backstab the target, causing 150% weapon damage plus 48 to the target. Must be behind the target. Requires a dagger in the main hand. Awards 1 combo point."},
[2591] = {name = "Backstab", description = "[q]Backstab the target, causing 150% weapon damage plus 69 to the target. Must be behind the target. Requires a dagger in the main hand. Awards 1 combo point."},
...
[2643] = {name = "Multi-Shot", description = "[q]Fires several missiles, hitting 3 targets."},
...
[2767] = {name = "Shadow Word: Pain", description = "[q]A word of darkness that causes 366 Shadow damage over 18 sec."},
...
[2941] = {name = "Immolate", description = "[q]Burns the enemy for [ 101 * ( ( ( 1 ) ) ) ] Fire damage and then an additional 165 Fire damage over 15 sec."},
...
[3107] = {name = "Summon Eliza's Guard", description = "[q]Summons 3 of Eliza's Guards to aid her in battle for 2 min."},
...
[3110] = {name = "Firebolt", description = "[q]Deals 7 to 10 damage to a target."},
...
[3140] = {name = "Fireball", description = "[q]Hurls a fiery ball that causes 89 to 122 Fire damage and an additional 12 Fire damage over 8 sec."},
...
[3235] = {name = "Rancid Blood", description = "[q]Gives the caster 15% chance to deal 15 Shadow damage to nearby enemies when the caster is successfully hit. Lasts until cancelled."},
...
[3417] = {name = "Thrash", description = "[q]Adds a chance to do two additional attacks"},
...
[3472] = {name = "Holy Light", description = "[q]Heals a friendly target for 717 to 799."},
...
[3627] = {name = "Rejuvenation", description = "[q]Heals the target for 304 over 12 sec."},
...
[3827] = {name = "Ward of Laze", description = "[q]Summons a Ward of Laze that lasts 1 min. and curses nearby enemies every 3 sec., temporarily reducing their attack speed by $3826%."},
...
[4086] = {name = "Evasion", description = "[q]Increases the caster's chance to dodge by 25%. Lasts until cancelled."},
[4093] = {name = "Reconstruction", description = "[q]Ansirem's spell of scrying"},
[4102] = {name = "Gore", description = "[q]Deals 15 damage to a target over 15 sec"},
[4111] = {name = "Tough Shell", description = nil},
[4133] = {name = "Bruise", description = "[q]Adds a chance to Bruise a target, which lowers the targets armor value."},
...
[4629] = {name = "Rain of Fire", description = "[q]Does 375 fire damage to all enemies in the area of effect over 10 sec."},
...
[5116] = {name = "Concussive Shot", description = "[q]Dazes the target, slowing movement speed by 50% for 4 sec."},
...
[5177] = {name = "Wrath", description = "[q]Causes 28 to 33 Nature damage to the target."},
[5187] = {name = "Healing Touch", description = "[q]Heals a friendly target for 204 to 253."},
[5195] = {name = "Entangling Roots", description = "[q]Roots the target in place and causes 90 Nature damage over 18 sec. Damage caused may interrupt the effect. Only useable outdoors."},
...
[5242] = {name = "Battle Shout", description = "[q]The warrior shouts, increasing the melee attack power of all party members within 20 yards by 40. Lasts 2 min."},
...
[5271] = {name = "Cursed Blade", description = "[q]Increases the time between an enemy's attacks by 43% for 20 sec."},
...
[5588] = {name = "Hammer of Justice", description = "[q]Stuns the target for 4 sec."},
[5589] = {name = "Hammer of Justice", description = "[q]Stuns the target for 5 sec."},
...
[5740] = {name = "Rain of Fire", description = "[q]Calls down a fiery rain to burn enemies in the area of effect for 168 Fire damage over 8 sec."},
...
[6060] = {name = "Smite", description = "[q]Smite an enemy for 222 to 250 Holy damage."},
[6063] = {name = "Heal", description = "[q]Heal your target for 586 to 662."},
[6064] = {name = "Heal", description = "[q]Heal your target for 734 to 827."},
[6066] = {name = "Power Word: Shield", description = "[q]Draws on the soul of the party member to shield them, absorbing 394 damage. Lasts 30 sec. While the shield holds, spellcasting will not be interrupted by damage. Once shielded, the target cannot be shielded again for 15 sec."},
[6074] = {name = "Renew", description = "[q]Heals the target of 100 damage over 15 sec."},
[6075] = {name = "Renew", description = "[q]Heals the target of 175 damage over 15 sec."},
[6076] = {name = "Renew", description = "[q]Heals the target of 245 damage over 15 sec."},
[6077] = {name = "Renew", description = "[q]Heals the target of 315 damage over 15 sec."},
[6078] = {name = "Renew", description = "[q]Heals the target of 400 damage over 15 sec."},
[6122] = {name = "Summon Vekniss Borer", description = nil},
[6141] = {name = "Blizzard", description = "[q]Ice shards pelt the target area doing [ 45 * 8 * ( 1 ) ] Frost damage over 8 sec."},
[6143] = {name = "Frost Ward", description = "[q]Absorbs 165 Frost damage. Lasts 30 sec."},
[6146] = {name = "Slow", description = "[q]Slows the enemy's movement by 60% and their attack speed by 54% for 15 sec."},
[6190] = {name = "Demoralizing Shout", description = "[q]Reduces the melee attack power of all enemies within 10 yards by 65 for 30 sec."},
[6192] = {name = "Battle Shout", description = "[q]The warrior shouts, increasing the melee attack power of all party members within 20 yards by 60. Lasts 2 min."},
[6205] = {name = "Curse of Weakness", description = "[q]Damage caused by the target is reduced by 10 for 2 min. Only one Curse per Warlock can be active on any one target."},
[6215] = {name = "Fear", description = "[q]Strikes fear in the enemy, causing it to run in fear for up to 20 sec. Damage caused may interrupt the effect. Only 1 target can be feared at a time."},
[6219] = {name = "Rain of Fire", description = "[q]Calls down a fiery rain to burn enemies in the area of effect for 384 Fire damage over 8 sec."},
[6222] = {name = "Corruption", description = "[q]Corrupts the target, causing 90 Shadow damage over 15 sec."},
[6223] = {name = "Corruption", description = "[q]Corrupts the target, causing 222 Shadow damage over 18 sec."},
[6229] = {name = "Shadow Ward", description = "[q]Absorbs 290 shadow damage. Lasts 30 sec."},
[6236] = {name = "Form of the Moonstalker", description = nil},
[6251] = {name = "Summon Crimson Cannon", description = "[q]Summons a cannon that will fire at enemies in front of it that are attacking you."},
...
[6255] = {name = "Lizard Bolt", description = "[q]Inflicts 14 to 16 Nature damage to an enemy."},
...
[6331] = {name = "Pet Recovery", description = "[q]Increases the pet's Spirit by 2. Must be trained using beast training."},
...
[6363] = {name = "Searing Totem", description = "[q]Summons a Searing Totem with 5 health at your feet for 35 sec that repeatedly attacks an enemy within 20 yards for 13 to 17 Fire damage."},
[6364] = {name = "Searing Totem", description = "[q]Summons a Searing Totem with 5 health at your feet for 40 sec that repeatedly attacks an enemy within 20 yards for 19 to 25 Fire damage."},
...
[6546] = {name = "Rend", description = "[q]Wounds the target causing them to bleed for 28 damage over 12 sec."},
[6547] = {name = "Rend", description = "[q]Wounds the target causing them to bleed for 45 damage over 15 sec."},
[6548] = {name = "Rend", description = "[q]Wounds the target causing them to bleed for 66 damage over 18 sec."},
...
[6634] = {name = "Phasing Stealth", description = "[q]Puts the caster in stealth mode for 8 sec."},
...
[6673] = {name = "Battle Shout", description = "[q]The warrior shouts, increasing the melee attack power of all party members within 20 yards by 20. Lasts 2 min."},
...
[6752] = {name = "Weak Poison Proc", description = "[q]Adds a chance to poison a target on a successful hit."},
...
[6778] = {name = "Healing Touch", description = "[q]Heals a friendly target for 762 to 914."},
...
[7322] = {name = "Frostbolt", description = "[q]Launches a bolt of frost at the enemy, causing [74$ * ( 1 ) ] to [82 * ( 1 ) ] Frost damage and slowing movement speed by 40% for 7 sec."},
...
[7372] = {name = "Hamstring", description = "[q]Maims the enemy, causing 18 damage and slowing the enemy's movement by 45% for 15 sec."},
[7373] = {name = "Hamstring", description = "[q]Maims the enemy, causing 45 damage and slowing the enemy's movement by 50% for 15 sec."},
[7386] = {name = "Sunder Armor", description = "[q]Sunders the target's armor, reducing it by 90 per Sunder Armor and causes a high amount of threat. Can be applied up to 5 times. Lasts 30 sec."},
...
[7405] = {name = "Sunder Armor", description = "[q]Sunders the target's armor, reducing it by 180 per Sunder Armor and causes a high amount of threat. Can be applied up to 5 times. Lasts 30 sec."},
...
[7621] = {name = "Arugal's Curse", description = "[q]Transforms an enemy into a Shadowfang Glutton, enslaving it to the caster's will for 10 sec."},
...
[7646] = {name = "Curse of Weakness", description = "[q]Damage caused by the target is reduced by 15 for 2 min. Only one Curse per Warlock can be active on any one target."},
...
[7816] = {name = "Lash of Pain", description = "[q]An instant attack that lashes the target, causing 60 Shadow damage."},
...
[8004] = {name = "Lesser Healing Wave", description = "[q]Heals a friendly target for 170 to 195."},
[8005] = {name = "Healing Wave", description = "[q]Heals a friendly target for 759 to 874."},
...
[8046] = {name = "Earth Shock", description = "[q]Instantly shocks the target with concussive force, causing 126 to 134 Nature damage. It also interrupts spellcasting and prevents any spell in that school from being cast for 2 sec. Causes a high amount of threat."},
[8050] = {name = "Flame Shock", description = "[q]Instantly sears the target with fire, causing 25 Fire damage immediately and 28 Fire damage over 12 sec."},
[8052] = {name = "Flame Shock", description = "[q]Instantly sears the target with fire, causing 51 Fire damage immediately and 48 Fire damage over 12 sec."},
[8053] = {name = "Flame Shock", description = "[q]Instantly sears the target with fire, causing 95 Fire damage immediately and 96 Fire damage over 12 sec."},
[8056] = {name = "Frost Shock", description = "[q]Instantly shocks the target with frost, causing 95 to 101 Frost damage and slowing movement speed by 50%. Lasts 8 sec."},
[8058] = {name = "Frost Shock", description = "[q]Instantly shocks the target with frost, causing 215 to 230 Frost damage and slowing movement speed by 50%. Lasts 8 sec."},
...
[8129] = {name = "Mana Burn", description = "[q]Drains 198 to 211 mana from a target. For each mana drained in this way, the target takes 0.5 Shadow damage."},
[8131] = {name = "Mana Burn", description = "[q]Drains 315 to 336 mana from a target. For each mana drained in this way, the target takes 0.5 Shadow damage."},
[8134] = {name = "Lightning Shield", description = "[q]The caster is surrounded by 3 balls of lightning. When a spell, melee or ranged attack hits the caster, the attacker will be struck for 114 Nature damage. This expends one lightning ball. Only one ball will fire every few seconds. Lasts 10 min."},
...
[8143] = {name = "Tremor Totem", description = "[q]Summons a Tremor Totem with 5 health at the feet of the caster that shakes the ground around it, removing Fear, Charm and Sleep effects from party members within 30 yards. Lasts 2 min."},
...
[8154] = {name = "Stoneskin Totem", description = "[q]Summons a Stoneskin Totem with 5 health at the feet of the caster. The totem protects party members within 20 yards, reducing melee damage taken by 7. Lasts 2 min."},
...
[8160] = {name = "Strength of Earth Totem", description = "[q]Summons a Strength of Earth Totem with 5 health at the feet of the caster. The totem increases the strength of party members within 20 yards by 20. Lasts 2 min."},
...
[8176] = {name = "Summon Felhunter", description = "[q]Summons a guardian felhunter that will protect you for 1 hour."},
...
[8190] = {name = "Magma Totem", description = "[q]Summons a Magma Totem with 5 health at the feet of the caster for 20 sec that causes 22 Fire damage to creatures within 8 yards every 2 seconds."},
...
[8312] = {name = "Trap", description = "[q]Renders a target unable to move for 10 sec."},
...
[8380] = {name = "Sunder Armor", description = "[q]Sunders the target's armor, reducing it by 270 per Sunder Armor and causes a high amount of threat. Can be applied up to 5 times. Lasts 30 sec."},
...
[8400] = {name = "Fireball", description = "[q]Hurls a fiery ball that causes 146 to 195 Fire damage and an additional 20 Fire damage over 8 sec."},
[8401] = {name = "Fireball", description = "[q]Hurls a fiery ball that causes 207 to 274 Fire damage and an additional 28 Fire damage over 8 sec."},
[8406] = {name = "Frostbolt", description = "[q]Launches a bolt of frost at the enemy, causing [126$ * ( 1 ) ] to [138 * ( 1 ) ] Frost damage and slowing movement speed by 40% for 7 sec."},
[8422] = {name = "Flamestrike", description = "[q]Calls down a pillar of fire, burning all enemies within the area for 159 to 197 Fire damage and an additional 140 Fire damage over 8 sec."},
[8435] = {name = "Forked Lightning", description = "[q]Inflicts 5 Nature damage to enemies in a cone in front of the caster."},
[8437] = {name = "Arcane Explosion", description = "[q]Causes an explosion of arcane magic around the caster, causing 60 to 66 Arcane damage to all targets within 10 yards."},
[8439] = {name = "Arcane Explosion", description = "[q]Causes an explosion of arcane magic around the caster, causing 143 to 156 Arcane damage to all targets within 10 yards."},
[8457] = {name = "Fire Ward", description = "[q]Absorbs 290 Fire damage. Lasts 30 sec."},
...
[8552] = {name = "Curse of Weakness", description = "[q]Damage caused by the target is reduced by 5 for 2 min."},
...
[8629] = {name = "Gouge", description = "[q]Causes 32 damage, incapacitating the opponent for 4 sec, and turns off your attack. Target must be facing you. Any damage caused will revive the target. Awards 1 combo point."},
...
[8713] = {name = "Overwhelming Musk", description = "[q]Causes the caster to periodically inflict 25 Nature damage to all enemies in a selected area, interrupting their casting for 5 sec. Lasts until cancelled."},
...
[8721] = {name = "Backstab", description = "[q]Backstab the target, causing 150% weapon damage plus 90 to the target. Must be behind the target. Requires a dagger in the main hand. Awards 1 combo point."},
[8722] = {name = "Summon Succubus", description = "[q]Summons 1 Succubus to accompany the caster until dismissed."},
[8732] = {name = "Thunderclap", description = "[q]Damages all nearby enemies for 204 to 276 nature damage"},
...
[8812] = {name = "Heal", description = "[q]Heals the caster for 1041 to 1174."},
...
[8876] = {name = "Thrash", description = "[q]Adds a chance to do two additional attacks"},
[8909] = {name = "Unholy Shield", description = "[q]Increases the caster's armor and resistance to spells for 10 min."},
[8927] = {name = "Moonfire", description = "[q]Burns the enemy for 70 to 82 Arcane damage and then an additional 124 Arcane damage over 12 sec."},
...
[8996] = {name = "Shoot", description = "[q]Fire at the target with a ranged weapon."},
...
[9484] = {name = "Shackle Undead", description = "[q]Shackles the target undead enemy for up to 30 sec. The shackled unit is unable to move, attack or cast spells. Any damage caused will release the target. Only one target can be shackled at a time."},
[9488] = {name = "Fireball", description = "[q]Inflicts Fire damage to an enemy."},
...
[9657] = {name = "Shadow Shell", description = "[q]Increases armor for 10 sec."},
...
[9835] = {name = "Moonfire", description = "[q]Burns the enemy for 195 to 228 Arcane damage and then an additional 384 Arcane damage over 12 sec."},
...
[9915] = {name = "Frost Nova", description = "[q]Inflicts 49 to 56 Frost damage to nearby enemies, immobilizing them for up to 10 sec."},
...
[10149] = {name = "Fireball", description = "[q]Hurls a fiery ball that causes 404 to 518 Fire damage and an additional 52 Fire damage over 8 sec."},
[10151] = {name = "Fireball", description = "[q]Hurls a fiery ball that causes 561 to 715 Fire damage and an additional 72 Fire damage over 8 sec."},
[10161] = {name = "Cone of Cold", description = "[q]Targets in a cone in front of the caster take [335 * ( 1 ) ] to [365 * ( 1 ) ] Frost damage and are slowed by 50% for 8 sec."},
[10179] = {name = "Frostbolt", description = "[q]Launches a bolt of frost at the enemy, causing [292$ * ( 1 ) ] to [316 * ( 1 ) ] Frost damage and slowing movement speed by 40% for 9 sec."},
...
[10212] = {name = "Arcane Missiles", description = "[q]Launches Arcane Missiles at the enemy, causing 196 Arcane damage each second for 5 sec."},
...
[10277] = {name = "Throw", description = "[q]Throws a weapon at an enemy, inflicting Physical damage."},
[10293] = {name = "Devotion Aura", description = "[q]Gives 735 additional armor to party members within 30 yards. Players may only have one Aura on them per Paladin at any one time."},
[10310] = {name = "Lay on Hands", description = "[q]Heals a friendly target for an amount equal to the Paladin's maximum health and restores 550 of their mana. Drains all of the Paladin's remaining mana when used."},
...
[10395] = {name = "Healing Wave", description = "[q]Heals a friendly target for 1040 to 1191."},
...
[10414] = {name = "Earth Shock", description = "[q]Instantly shocks the target with concussive force, causing 517 to 545 Nature damage. It also interrupts spellcasting and prevents any spell in that school from being cast for 2 sec. Causes a high amount of threat."},
...
[10473] = {name = "Frost Shock", description = "[q]Instantly shocks the target with frost, causing 492 to 520 Frost damage and slowing movement speed by 50%. Lasts 8 sec."},
...
[10577] = {name = "Heal", description = "[q]Heal friendly target for 300 to 500."},
...
[10651] = {name = "Curse of the Eye", description = "[q]Curses a target by lowering damage done by 8 for 2 min"},
...
[10722] = {name = "Silithid Swarm", description = "[q]Summons 1 Silithid Swarm to accompany the caster until dismissed."},
...
[10875] = {name = "Mana Burn", description = "[q]Drains 585 to 620 mana from a target. For each mana drained in this way, the target takes 0.5 Shadow damage."},
...
[10892] = {name = "Shadow Word: Pain", description = "[q]A word of darkness that causes 510 Shadow damage over 18 sec."},
[10893] = {name = "Shadow Word: Pain", description = "[q]A word of darkness that causes 672 Shadow damage over 18 sec."},
[10894] = {name = "Shadow Word: Pain", description = "[q]A word of darkness that causes 852 Shadow damage over 18 sec."},
[10928] = {name = "Renew", description = "[q]Heals the target of 650 damage over 15 sec."},
[10934] = {name = "Smite", description = "[q]Smite an enemy for 384 to 429 Holy damage."},
[10946] = {name = "Mind Blast", description = "[q]Blasts the target for 437 to 461 Shadow damage, but causes a high amount of threat."},
[10947] = {name = "Mind Blast", description = "[q]Blasts the target for 508 to 537 Shadow damage, but causes a high amount of threat."},
[10961] = {name = "Prayer of Healing", description = "[q]A powerful prayer heals party members within 30 yards for 939 to 991."},
...
[11013] = {name = "Sneak", description = "[q]Allows the caster to play the animation for stealth without the invis."},
...
[11397] = {name = "Diseased Shot", description = "[q]Inflicts normal damage plus 1 to an enemy, reducing its Strength by 10 and its Agility by 10 for 5 min."},
...
[11504] = {name = "Walking Bomb Effect", description = "[q]Detonates causing damage in an area."},
...
[11567] = {name = "Heroic Strike", description = "[q]A strong attack that increases melee damage by 138 and causes a high amount of threat."},
...
[11647] = {name = "Power Word: Shield", description = "[q]Wraps the caster in a shield that lasts up to 30 sec., absorbing a maximum of 801 Physical or magical damage. While the shield holds, spells will not be interrupted by Physical attacks."},
[11659] = {name = "Shadow Bolt", description = "[q]Sends a shadowy bolt at the enemy, causing 292 to 327 Shadow damage."},
[11660] = {name = "Shadow Bolt", description = "[q]Sends a shadowy bolt at the enemy, causing 373 to 415 Shadow damage."},
[11667] = {name = "Immolate", description = "[q]Burns the enemy for [ 208 * ( ( ( 1 ) ) ) ] Fire damage and then an additional 365 Fire damage over 15 sec."},
[11668] = {name = "Immolate", description = "[q]Burns the enemy for [ 258 * ( ( ( 1 ) ) ) ] Fire damage and then an additional 485 Fire damage over 15 sec."},
[11671] = {name = "Corruption", description = "[q]Corrupts the target, causing 486 Shadow damage over 18 sec."},
[11672] = {name = "Corruption", description = "[q]Corrupts the target, causing 666 Shadow damage over 18 sec."},
...
[11700] = {name = "Drain Life", description = "[q]Transfers 71 health every second from the target to the caster. Lasts 5 sec."},
...
[11820] = {name = "Electrified Net", description = "[q]Immobilizes an enemy for 10 sec. and shocks it with electricity, inflicting Nature damage."},
...
[11988] = {name = "Fireball Volley", description = "[q]Inflicts Fire damage to nearby enemies."},
...
[12250] = {name = "Summon Oozeling", description = "[q]Summons 1 Oozeling to aid the caster in battle for 4 min."},
...
[12544] = {name = "Frost Armor", description = "[q]Encases the caster in a layer of frost that lasts 30 min. The thick ice increases armor by 12, slows melee attackers' movement to 25%, and increases the time between their attacks by 30%."},
...
[12555] = {name = "Pummel", description = "[q]Pummels an enemy for 15 damage and interrupts the spell being cast for 5 sec."},
[12556] = {name = "Frost Armor", description = nil},
[12557] = {name = "Cone of Cold", description = "[q]Inflicts Frost damage to enemies in a cone in front of the caster, reducing their movement speed for 8 sec."},
...
[12787] = {name = "Thrash", description = "[q]Adds a chance to do two additional attacks."},
...
[12824] = {name = "Polymorph", description = "[q]Transforms the enemy into a sheep, forcing it to wander around for up to 30 sec. While wandering, the sheep cannot attack or cast spells but will regenerate very quickly. Any damage will transform the target back into its normal form. Only one target can be polymorphed at a time. Only works on Beasts, Humanoids and Critters."},
[12867] = {name = "Deep Wounds", description = "[q]Your critical strikes cause the opponent to bleed, dealing 60% of your melee weapon's average damage over 12 sec."},
...
[12947] = {name = "Withered Touch", description = "[q]Adds a chance to cast Withered Touch on enemy when hit by a melee attack."},
...
[13022] = {name = "Fire and Arcane Reflect", description = "[q]Reflect fire and arcane spells back at the caster"},
...
[13180] = {name = "Gnomish Mind Control Cap", description = "[q]Engage in mental combat with a humanoid target to try and control their mind. If all works well, you will control the mind of the target for 20 sec ....."},
...
[13339] = {name = "Fire Blast", description = "[q]Inflicts Fire damage to an enemy."},
[13340] = {name = "Fire Blast", description = "[q]Inflicts Fire damage to an enemy."},
[13341] = {name = "Fire Blast", description = "[q]Inflicts Fire damage to an enemy."},
[13342] = {name = "Fire Blast", description = "[q]Inflicts Fire damage to an enemy."},
...
[13439] = {name = "Frostbolt", description = "[q]Launches a bolt of frost at the enemy causing 20 to 30 Frost damage and slowing movement speed by 50% for 5 sec."},
...
[13518] = {name = "Poison", description = "[q]Poisons target for 5 Nature damage every 3 sec for 15 sec."},
[13532] = {name = "Thunder Clap", description = "[q]Blasts nearby enemies with thunder increasing the time between their attacks by 11% for 10 sec and doing 7 Nature damage to them. Will affect up to 4 targets."},
[13534] = {name = "Disarm", description = "[q]Disarm target's weapon for 10 sec."},
...
[13582] = {name = "Deadly Poison", description = "[q]Inflicts 2 Nature damage to nearby enemies every 10 sec. for 2 min."},
...
[13730] = {name = "Demoralizing Shout", description = "[q]Reduces the melee attack power of nearby enemies by 10 for 30 sec."},
...
[13878] = {name = "Scorch", description = "[q]Scorches an enemy for Fire damage."},
...
[13899] = {name = "Fire Storm", description = "[q]Calls down a pillar of flame, burning all enemies in a selected area for 324 to 376 Fire damage and an additional 185 to 215 damage every 3 sec. for 30 sec."},
[13900] = {name = "Fiery Burst", description = "[q]Inflicts Fire damage to all enemies in a selected area."},
...
[14118] = {name = "Rend", description = "[q]Wounds the target causing them to bleed for 150 damage over 30 sec."},
...
[14145] = {name = "Fire Blast", description = "[q]Inflicts Fire damage to an enemy."},
...
[14158] = {name = "Murder", description = "[q]Increases all damage caused against Humanoid, Giant, Beast and Dragonkin targets by 1%."},
...
[14267] = {name = "Wing Clip", description = "[q]Inflicts 25 damage and reduces the enemy target's movement speed by 55% for 10 sec."},
[14290] = {name = "Multi-Shot", description = "[q]Fires several missiles, hitting 3 targets for an additional 120 damage."},
[14292] = {name = "Fling Torch", description = nil},
[14295] = {name = "Volley", description = "[q]Continuously fires a volley of ammo at the target area, causing 80 Arcane damage to enemy targets within 8 yards every second for 6 sec."},
[14297] = {name = "Shadow Storm", description = "[q]Throws shadowbolts at any enemies between 25 and 45 feet"},
...
[14514] = {name = "Blink", description = "[q]Teleports the caster 20 yd. forward unless something is in the way. Also frees the caster from any bonds."},
...
[14873] = {name = "Sinister Strike", description = "[q]Inflicts normal damage plus 1 to an enemy."},
...
[14895] = {name = "Overpower", description = "[q]Instantly overpowers an enemy, causing weapon damage plus 15. Can only be used after the target dodges. Overpower cannot be blocked, dodged, or parried."},
...
[15041] = {name = "Fire Ward", description = "[q]Surrounds the caster with a shield that lasts 1 min. and can absorb a fixed amount of Fire damage."},
...
[15044] = {name = "Frost Ward", description = "[q]Surrounds the caster with a shield that lasts 1 min. and can absorb a fixed amount of Frost damage."},
[15061] = {name = "Enrage", description = "Physical damage dealt is increased by 1.\nAttack speed increased by 30%."},
[15062] = {name = "Shield Wall", description = "[q]Reduces the Physical and magical damage taken by the caster by 75% for 10 sec."},
[15063] = {name = "Frost Nova", description = "[q]Inflicts Frost damage to nearby enemies, immobilizing them for up to 8 sec."},
[15087] = {name = "Evasion", description = "[q]Increases the rogue's chance to dodge by 50% for 15 sec."},
[15089] = {name = "Frost Shock", description = "[q]Inflicts Frost damage to an enemy and reduces its movement speed for 8 sec."},
[15090] = {name = "Dispel Magic", description = "[q]Dispels magic on the target, removing 1 harmful spell from an ally or 1 beneficial spell from an enemy."},
[15091] = {name = "Blast Wave", description = "[q]Unleashes a wave of flame, inflicting Fire damage to nearby enemies and reducing their movement speed for 6 sec."},
...
[15122] = {name = "Counterspell", description = "[q]Counters an enemy's spell, preventing the enemy from casting that spell again for 15 sec. Generates a high amount of threat."},
...
[15241] = {name = "Scorch", description = "[q]Scorches an enemy for Fire damage."},
...
[15244] = {name = "Cone of Cold", description = "[q]Inflicts Frost damage to enemies in a cone in front of the caster, reducing their movement speed for 8 sec."},
...
[15280] = {name = "Cleave Armor", description = "[q]Reduces targets armor by 300 for 20 sec."},
...
[15288] = {name = "Fury of Ragnaros", description = "[q]Increases the magical damage dealt by an ally by 25 for 30 min."},
...
[15306] = {name = "Shock", description = "[q]Instantly throws a bolt of lightning at an enemy, inflicting Nature damage."},
[15326] = {name = "Blackout", description = "[q]Gives your Shadow damage spells a 10% chance to stun the target for 3 sec."},
[15337] = {name = "Spirit Tap", description = "[q]Gives you a 80% chance to gain a 100% bonus to your Spirit after killing a target that yields experience. For the duration, your Mana will regenerate at a 50% rate while casting. Lasts 15 sec."},
...
[15398] = {name = "Psychic Scream", description = "[q]The caster lets out a psychic scream, causing an enemy to be frozen in fear for 8 sec."},
[15438] = {name = "Thorns", description = "[q]When struck in combat inflicts 3 Arcane damage to the attacker."},
...
[15487] = {name = "Silence", description = "[q]Silences the target, preventing them from casting spells for 5 sec."},
...
[15547] = {name = "Shoot", description = "[q]Shoots at an enemy, inflicting Physical damage."},
...
[15581] = {name = "Sinister Strike", description = "[q]Inflicts normal damage plus 3 to an enemy."},
[15582] = {name = "Backstab", description = "[q]Inflicts normal damage plus 30 to an enemy, but only if attacking from behind."},
[15583] = {name = "Rupture", description = "[q]Inflicts Physical damage to an enemy every 2 sec. for 10 sec."},
...
[15594] = {name = "Force of Will", description = "[q]When struck in combat has a 1% chance of reducing all melee damage taken by 25 for 10 sec."},
[15605] = {name = "Shock", description = "[q]Instantly throws a bolt of lightning at an enemy, inflicting Nature damage."},
[15607] = {name = "Throw", description = "[q]Throws a weapon at an enemy, inflicting Physical damage."},
...
[15611] = {name = "Lizard Bolt", description = "[q]Inflicts Nature damage to an enemy."},
[15614] = {name = "Kick", description = "[q]Kicks an enemy for 4 damage, interrupting the spell being cast for 6 sec."},
[15615] = {name = "Pummel", description = "[q]Pummels an enemy for 45 damage and interrupts the spell being cast for 5 sec."},
...
[15620] = {name = "Shoot", description = "[q]Shoots at an enemy, inflicting Physical damage."},
...
[15667] = {name = "Sinister Strike", description = "[q]Inflicts normal damage plus 2 to an enemy."},
...
[15692] = {name = "Eviscerate", description = "[q]Eviscerates an enemy, inflicting 2 Physical damage."},
...
[15736] = {name = "Arcane Missiles", description = "[q]Launches a magical missile at an enemy, inflicting Arcane damage."},
...
[15744] = {name = "Blast Wave", description = "[q]Unleashes a wave of flame, inflicting Fire damage to nearby enemies and reducing their movement speed for 6 sec."},
[15746] = {name = "Disturb Rookery Egg", description = nil},
[15749] = {name = "Shield Charge", description = "[q]Charges an enemy, knocking it back and inflicting normal damage plus 150."},
...
[15784] = {name = "Frost Armor", description = "[q]Encases an ally in a layer of frost that lasts 1 min. The thick ice increases armor by 12, slows melee attackers' movement to 25%, and increases the time between their attacks by 30%."},
...
[15791] = {name = "Arcane Missiles", description = "[q]Launches magical missiles at an enemy, inflicting Arcane damage."},
...
[15795] = {name = "Throw", description = "[q]Throws a weapon at an enemy, inflicting Physical damage."},
...
[16000] = {name = "Throw", description = "[q]Throws a weapon at an enemy, inflicting Physical damage."},
[16001] = {name = "Impale", description = "[q]Inflicts Physical damage to an enemy every 3 sec. for 9 sec."},
...
[16046] = {name = "Blast Wave", description = "[q]Unleashes a wave of flame, inflicting Fire damage to nearby enemies and reducing their movement speed for 6 sec."},
...
[16100] = {name = "Shoot", description = "[q]Shoots at an enemy, inflicting Physical damage."},
...
[16144] = {name = "Fire Blast", description = "[q]Inflicts Fire damage to an enemy."},
...
[16243] = {name = "Ribbon of Souls", description = "[q]Inflicts 107 to 143 Shadow damage to an enemy."},
[16244] = {name = "Demoralizing Shout", description = "[q]Reduces the melee attack power of nearby enemies by 20 for 30 sec."},
...
[16380] = {name = "Greater Invisibility", description = "[q]Turns the caster invisible until the effect is cancelled."},
[16381] = {name = "Summon Rockwing Gargoyles", description = "[q]Summons 2 Rockwing Gargoyles to accompany the caster until dismissed."},
...
[16412] = {name = "Fireball", description = "[q]Hurls a fiery ball that causes 135 to 165 Fire damage and an additional 12 damage over 6 sec."},
...
[16469] = {name = "Web Explosion", description = "[q]Renders a target unable to move for 10 sec"},
...
[16496] = {name = "Shoot", description = "[q]Shoots at an enemy, inflicting Physical damage."},
...
[16508] = {name = "Intimidating Roar", description = "[q]Roars at an enemy, paralyzing it with terror for 8 sec. and causing all other nearby enemies to flee in fear."},
...
[16554] = {name = "Toxic Bolt", description = "[q]Inflicts Nature damage to an enemy."},
...
[16568] = {name = "Mind Flay", description = "[q]Inflicts Shadow damage to an enemy and reduces its movement speed for 3 sec."},
...
[16576] = {name = "Piercing Screech", description = "[q]Inflicts 43 to 57 Shadow damage to nearby enemies."},
...
[16636] = {name = "Berserker Charge", description = "[q]Charges at an enemy, knocking it back and inflicting normal damage plus 300."},
...
[16785] = {name = "Flamebreak", description = "[q]Inflicts Fire damage to nearby enemies, knocking them back."},
...
[17012] = {name = "Devour Magic", description = "[q]Purges an enemy of 1 magic effect and heals the caster for 1000."},
...
[17137] = {name = "Flash Heal", description = "[q]Calls upon Holy magic to heal an ally."},
[17138] = {name = "Flash Heal", description = "[q]Calls upon Holy magic to heal an ally."},
...
[17141] = {name = "Holy Fire", description = "[q]Consumes an enemy in flames, burning it and inflicting additional Fire damage every 2 sec. over 8 sec."},
[17142] = {name = "Holy Fire", description = "[q]Consumes an enemy in flames, burning it and inflicting additional Fire damage every 2 sec. over 8 sec."},
...
[17145] = {name = "Blast Wave", description = "[q]Unleashes a wave of flame, inflicting Fire damage to nearby enemies and reducing their movement speed for 6 sec."},
...
[17150] = {name = "Arcane Might", description = "[q]Increases the magical damage dealt by an ally by 50 for 30 min."},
[17151] = {name = "Shadow Barrier", description = "[q]Reduces the Shadow damage taken by an ally by 50 for 10 min."},
...
[17165] = {name = "Mind Flay", description = "[q]Inflicts Shadow damage to an enemy and reduces its movement speed for 3 sec."},
...
[17195] = {name = "Scorch", description = "[q]Scorches an enemy for Fire damage."},
[17197] = {name = "Maggot Goo", description = "[q]Poisons nearby enemies for 203 to 247 damage, then inflicts an additional 22 to 28 Nature damage every 2 sec. for 6 sec."},
[17201] = {name = "Dispel Magic", description = "[q]Dispels magic on an ally, removing 1 harmful spell."},
...
[17273] = {name = "Pyroblast", description = "[q]Inflicts Fire damage to an enemy, then additional damage every 3 sec. for 12 sec."},
[17274] = {name = "Pyroblast", description = "[q]Inflicts Fire damage to an enemy, then additional damage every 3 sec. for 12 sec."},
[17276] = {name = "Scald", description = "[q]Scalds an enemy for Fire damage, stunning it for 4 sec."},
[17277] = {name = "Blast Wave", description = "[q]Unleashes a wave of flame, inflicting Fire damage to nearby enemies and reducing their movement speed for 6 sec."},
...
[17312] = {name = "Mind Flay", description = "[q]Assault the target's mind with Shadow energy, causing 186 Shadow damage over 3 sec and slowing their movement speed by 50%."},
[17321] = {name = "Spirit Spawn-in", description = nil},
[17330] = {name = "Poison", description = "[q]Poisons target for 20 Nature damage every 2 sec for 20 sec."},
[17353] = {name = "Shoot", description = "[q]Shoots at an enemy, inflicting Physical damage."},
...
[17435] = {name = "Shadow Bolt", description = "[q]Hurls a bolt of dark magic at an enemy, inflicting Shadow damage."},
...
[17492] = {name = "Hand of Thaurissan", description = "[q]Inflicts Fire damage to an enemy, stunning it for 5 sec."},
...
[17504] = {name = "Rend", description = "[q]Wounds the target causing them to bleed for 120 damage over 30 sec."},
...
[17616] = {name = "Corpse Explosion", description = "[q]Causes a corpse to explode, inflicting 1500 Shadow damage on enemies near the corpse."},
...
[17651] = {name = "Image Projection", description = "[q]Summons 5 Spectral Projections to fight in the place of the caster, who becomes invisible and invulnerable, though unable to act. After 6 sec., these apparitions sacrifice their lives to heal the caster, who resumes the battle."},
[17682] = {name = "Drain Mana", description = "[q]Drains up to 100 mana from an enemy over 5 sec. and transfers it to the caster."},
...
[17843] = {name = "Flash Heal", description = "[q]Calls upon Holy magic to heal an ally."},
...
[18075] = {name = "Rend", description = "[q]Wounds the target causing them to bleed for 50 damage over 30 sec."},
[18089] = {name = "Lightning Bolt", description = "[q]Blasts a target for 45 to 75 Nature damage."},
...
[18100] = {name = "Frost Armor", description = "[q]Encases the caster in a layer of frost that lasts 30 min. The thick ice increases armor by 12, slows melee attackers' movement to 40%, and increases the time between their attacks by 100%."},
[18103] = {name = "Backhand", description = "[q]Backhands an enemy, stunning it for 2 sec."},
[18105] = {name = "Fireball", description = "[q]Hurls a fiery ball that causes 180 to 220 Fire damage and an additional 52 damage over 8 sec."},
[18106] = {name = "Rend", description = "[q]Wounds the target causing them to bleed for 840 damage over 30 sec."},
[18108] = {name = "Fireball", description = "[q]Hurls a fiery ball that causes 270 to 330 Fire damage and an additional 36 damage over 8 sec."},
...
[18200] = {name = "Rend", description = "[q]Wounds the target causing them to bleed for 130 damage over 30 sec."},
...
[18278] = {name = "Silence", description = "[q]Silences an enemy preventing it from casting spells for 6 sec."},
...
[18328] = {name = "Incapacitating Shout", description = "[q]Reduces the movement speed of nearby enemies by 60% for 1 min."},
...
[18395] = {name = "Dismounting Shot", description = "[q]Knocks an enemy down, forcing it to dismount and stunning it for 2 sec."},
...
[18671] = {name = "Curse of Agony", description = "[q]Curses nearby enemies with agony, inflicting Shadow damage every 3 sec. for 30 sec. Only one curse per warlock can be active on any one target."},
...
[18879] = {name = "Siphon Life", description = "[q]Transfers 22 health from the target to the caster every 3 sec. Lasts 30 sec."},
...
[19099] = {name = "Blizzard", description = "[q]Calls down a blizzard that lasts 10 sec., inflicting 225 to 275 Frost damage every 2 sec. to all enemies in the nearby area."},
...
[19134] = {name = "Intimidating Shout", description = "[q]Shouts at an enemy, paralyzing it with terror for 8 sec. and causing all other nearby enemies to flee in fear."},
...
[19276] = {name = "Devouring Plague", description = "[q]Afflicts the target with a disease that causes 272 Shadow damage over 24 sec. Damage caused by the Devouring Plague heals the caster."},
[19312] = {name = "Shadowguard", description = "[q]The caster is surrounded by shadows. When a spell, melee or ranged attack hits the caster, the attacker will be struck for 116 Shadow damage. Attackers can only be damaged once every few seconds. This damage causes no threat. 3 charges. Lasts 10 min."},
...
[19471] = {name = "Berserker Charge", description = "[q]Charges at an enemy, knocking it back and inflicting normal damage plus 150."},
[19472] = {name = "Sinister Strike", description = "[q]Inflicts normal damage plus 1 to an enemy."},
...
[19577] = {name = "Intimidation", description = "[q]Command your pet to intimidate the target on the next successful melee attack, causing a high amount of threat and stunning the target for 3 sec."},
[19593] = {name = "Egg Explosion", description = "[q]Explode, hurting all nearby enemies for damage proportional to distance."},
[19595] = {name = "Shadow and Frost Reflect", description = "[q]Reflect shadow and frost spells back at their caster"},
[19627] = {name = "Fire Shield", description = "[q]Inflicts 250 Fire damage to nearby enemies."},
...
[19715] = {name = "Counterspell", description = "[q]Counters the spellcasting of nearby enemies, preventing any spell from that school of magic from being cast for 10 sec. Generates a high amount of threat."},
...
[20005] = {name = "Chilled", description = "[q]Target's movement slowed by 30% and time between attacks increased by 25% for 5 sec."},
...
[20229] = {name = "Blast Wave", description = "[q]Inflicts 694 to 806 Fire damage to nearby enemies and reduces their movement speed by 50% for 8 sec."},
...
[20420] = {name = "Fireball", description = "[q]Inflicts 1275 to 1725 Fire damage to an enemy."},
[20436] = {name = "Drunken Pit Crew", description = nil},
[20464] = {name = "Summon Skeleton", description = "[q]Summons 3 Skeletons to aid the caster in battle for 4 min."},
...
[20536] = {name = "Lightning Breath", description = "[q]Breathes lightning at an enemy, inflicting Nature damage."},
[20537] = {name = "Counterspell", description = "[q]Counters an enemy's spell, preventing the enemy from casting that spell again for 15 sec. Generates a high amount of threat."},
...
[20618] = {name = "Teleport", description = "[q]Teleports an enemy into the midst of burning coals."},
...
[20623] = {name = "Fire Blast", description = "[q]Inflicts 1080 to 1320 Fire damage to an enemy."},
...
[20691] = {name = "Cleave", description = "[q]Inflicts normal damage to an enemy and its nearest allies, affecting up to 5 targets."},
[20697] = {name = "Power Word: Shield", description = "[q]Wraps the caster in a shield that lasts up to 30 sec., absorbing a maximum of 5000 Physical or magical damage. While the shield holds, spells will not be interrupted by Physical attacks."},
[20712] = {name = "Flame Breath", description = "[q]Inflicts 833 to 967 Fire damage to enemies in a cone in front of the caster."},
[20714] = {name = "Fireball", description = "[q]Inflicts Fire damage to an enemy."},
...
[20720] = {name = "Arcane Bolt", description = "[q]Hurls a magical bolt at an enemy, inflicting Arcane damage."},
...
[20795] = {name = "Fire Blast", description = "[q]Inflicts Fire damage to an enemy."},
...
[20808] = {name = "Fireball", description = "[q]Inflicts Fire damage to an enemy."},
...
[20828] = {name = "Cone of Cold", description = "[q]Inflicts Frost damage to enemies in a cone in front of the caster, reducing their movement speed for 8 sec."},
[20829] = {name = "Arcane Bolt", description = "[q]Hurls a magical bolt at an enemy, inflicting Arcane damage."},
[20830] = {name = "Mind Blast", description = "[q]Inflicts Shadow damage to an enemy, but causes a high amount of threat."},
...
[20832] = {name = "Fire Blast", description = "[q]Inflicts Fire damage to an enemy."},
[20904] = {name = "Aimed Shot", description = "[q]An aimed shot that increases ranged damage by 600."},
...
[21068] = {name = "Corruption", description = "[q]Corrupts nearby enemies, inflicting Shadow damage every 3 sec. for 24 sec."},
...
[21080] = {name = "Putrid Breath", description = "[q]Adds a chance to cast Putrid Breath on enemy when hit by a melee attack."},
...
[21337] = {name = "Thorns", description = "[q]Thorns sprout from the friendly target causing 16 Nature damage to attackers when hit. Lasts 10 min."},
...
[21655] = {name = "Blink", description = "[q]Teleports the caster 20 yd. forward unless something is in the way. Also frees the caster from any bonds."},
[21667] = {name = "Wrath", description = "[q]Hurls a bolt of lightning at an enemy, inflicting 638 to 862 Nature damage."},
[21668] = {name = "Starfire", description = "[q]Causes 900 to 1100 Arcane damage to the target."},
...
[21793] = {name = "Twisted Tranquility", description = "[q]Deals nature damage to enemies in an area over 10 sec, slowing their movement by 70% and increasing the time between their attacks by 300%."},
...
[21869] = {name = "Repulsive Gaze", description = "[q]Roars at an enemy, paralyzing it with terror for 8 sec. and causing all other nearby enemies to flee in fear."},
...
[21949] = {name = "Rend", description = "[q]Wounds the target causing them to bleed for 230 damage over 30 sec."},
...
[22120] = {name = "Charge", description = "[q]Charges an enemy, inflicting normal damage plus 0."},
[22121] = {name = "Shoot", description = "[q]Shoots at an enemy, inflicting Physical damage."},
...
[22128] = {name = "Thorns", description = "[q]Thorns sprout from the friendly target causing 20 Nature damage to attackers when hit. Lasts 10 min."},
...
[22273] = {name = "Arcane Missiles", description = "[q]Launches magical missiles at an enemy, inflicting Arcane damage."},
...
[22351] = {name = "Thorns", description = "[q]Causes 1 Nature damage to any creature that strikes the caster."},
...
[22424] = {name = "Blast Wave", description = "[q]Unleashes a wave of flame, inflicting Fire damage to nearby enemies and reducing their movement speed for 6 sec."},
...
[22427] = {name = "Concussion Blow", description = "[q]A brutal strike that deals weapon damage and stuns the opponent for 5 sec."},
...
[22645] = {name = "Frost Nova", description = "[q]Inflicts Frost damage to nearby enemies, immobilizing them for up to 8 sec."},
...
[22696] = {name = "Thorns", description = "[q]Thorns sprout from the friendly target causing 32 Nature damage to attackers when hit. Lasts until cancelled."},
...
[22746] = {name = "Cone of Cold", description = "[q]Inflicts Frost damage to enemies in a cone in front of the caster, reducing their movement speed for 8 sec."},
...
[22823] = {name = "Starshards", description = "[q]Rains starshards down on the enemy target's head, causing 30 Arcane damage over 6 sec."},
...
[22886] = {name = "Berserker Charge", description = "[q]Charges at an enemy, knocking it back and inflicting normal damage plus 300."},
[22887] = {name = "Throw", description = "[q]Throws a weapon at an enemy, inflicting Physical damage."},
...
[22907] = {name = "Shoot", description = "[q]Shoots at an enemy, inflicting Physical damage."},
[22908] = {name = "Volley", description = "[q]Continuously fires a volley of ammo at the target area, causing 300 Arcane damage to enemy targets within 8 yards every second for 6 sec."},
...
[22910] = {name = "Immolation Trap", description = "[q]Place a fire trap that will burn the first enemy to approach for 690 Fire damage over 15 sec. Trap will exist for 1 min. Traps can only be placed when out of combat. Only one trap can be active at a time."},
[22911] = {name = "Charge", description = "[q]Charges an enemy, inflicting normal damage plus 0 and stuns the opponent for 2 sec."},
...
[22919] = {name = "Mind Flay", description = "[q]Inflicts Shadow damage to an enemy and reduces its movement speed for 3 sec."},
...
[23039] = {name = "Blast Wave", description = "[q]Unleashes a wave of flame, inflicting Fire damage to nearby enemies and reducing their movement speed for 6 sec."},
...
[23115] = {name = "Frost Shock", description = "[q]Inflicts Frost damage to an enemy and reduces its movement speed for 8 sec."},
...
[23262] = {name = "Demoralize", description = "[q]Reduces the melee attack power of an enemy by 10 for 30 sec."},
...
[23331] = {name = "Blast Wave", description = "[q]Unleashes a wave of flame, inflicting Fire damage to nearby enemies and reducing their movement speed for 8 sec."},
[23337] = {name = "Shoot", description = "[q]Shoots at an enemy, inflicting Physical damage."},
...
[23600] = {name = "Piercing Howl", description = "[q]Causes all enemies near the warrior to be dazed for 6 sec."},
...
[23858] = {name = "Holy Nova", description = "[q]Causes an explosion of divine light, inflicting 875 to 1125 Holy damage to nearby enemies and reducing the caster's threat level for until cancelled."},
[23859] = {name = "Dispel Magic", description = "[q]Dispels magic on an ally, removing 1 harmful spell."},
...
[24022] = {name = "Cleanse Nova", description = "[q]Causes an explosion of divine light, inflicting 1 Holy damage to nearby enemies and reducing the caster's threat level for until cancelled."},
[24023] = {name = "Charge", description = "[q]Charges an enemy, inflicting normal damage plus 0 and stuns the opponent for until cancelled."},
...
[24049] = {name = "Impale", description = "[q]Inflicts Physical damage to an enemy every 2 sec. for 10 sec."},
...
[24099] = {name = "Poison Bolt Volley", description = "[q]Shoots poison at an enemy, inflicting Nature damage, then additional damage every 2 sec. for 10 sec."},
...
[24185] = {name = "Bloodlust", description = "[q]Increases an ally's attack speed by 75% for 30 sec."},
...
[24332] = {name = "Rake", description = "[q]Rake the target for 32 to 48 damage and an additional 72 damage over 9 sec."},
...
[24335] = {name = "Wyvern Sting", description = "[q]A stinging shot that puts the target to sleep for 12 sec. Any damage will cancel the effect. When the target wakes up, the Sting causes 1314 to 1686 Nature damage over 12 sec."},
...
[24340] = {name = "Meteor", description = "[q]Do damage divided up evenly among all affected targets"},
...
[24407] = {name = "Overpower", description = "[q]Instantly overpowers an enemy, causing weapon damage plus 750. Can only be used after the target dodges. Overpower cannot be blocked, dodged, or parried."},
[24408] = {name = "Charge", description = "[q]Charges an enemy, inflicting normal damage plus 0 and stuns the opponent for 2 sec."},
...
[24893] = {name = "Black Sapphire", description = "[q]Increases the periodic damage of your Drain Soul spell by 222. Lasts 11 sec."},
...
[24976] = {name = "Insect Swarm", description = "[q]The enemy target is swarmed by insects, decreasing their chance to hit by 2% and causing 264 Nature damage over 12 sec."},
...
[25025] = {name = "Earth Shock", description = "[q]Shocks an enemy with concussive force, inflicting Nature damage and interrupting the spell being cast for 2 sec."},
...
[25085] = {name = "Bright Campfire", description = "[q]Builds a campfire that increases the spirits of those nearby by 8 and allows cooking."},
[25104] = {name = "Summon Player", description = "[q]Summons an enemy player."},
[25112] = {name = "Summon Voidwalker", description = "[q]Casts your Summon Voidwalker spell with no mana or Soul Shard requirements."},
...
[25292] = {name = "Holy Light", description = "[q]Heals a friendly target for 1590 to 1770."},
[25304] = {name = "Frostbolt", description = "[q]Launches a bolt of frost at the enemy, causing [515$ * ( 1 ) ] to [555 * ( 1 ) ] Frost damage and slowing movement speed by 40% for 9 sec."},
...
[25346] = {name = "Arcane Missiles", description = "[q]Launches an Arcane Missile at the enemy, causing 230 Arcane damage."},
...
[25699] = {name = "Explode", description = "[q]Sacrifices the caster's life in order to inflict 4688 to 5312 Fire damage to nearby enemies."},
[25710] = {name = "Heroic Strike", description = "[q]A strong attack that increases melee damage by 11 and causes a high amount of threat."},
[25712] = {name = "Heroic Strike", description = "[q]A strong attack that increases melee damage by 32 and causes a high amount of threat."},
[25721] = {name = "Feed", description = nil},
[25725] = {name = "Paralyze", description = "Stunned."},
[25743] = {name = "Dark Water", description = nil},
[25744] = {name = "Rampage", description = "[q]Charges an enemy, inflicting 1000 damage to the target and any of its nearby allies, as well as knocking them all back."},
...
[25787] = {name = "Surge", description = "[q]Charges an enemy, inflicting 600 damage to the target and any of its nearby allies, as well as knocking them all back."},
...
[25821] = {name = "Charge", description = "[q]Charges an enemy, inflicting normal damage plus 0 and stuns the opponent for 2 sec."},
...
[26044] = {name = "Mind Flay", description = "[q]Inflicts Shadow damage to an enemy and reduces its movement speed for 8 sec."},
...
[26379] = {name = "Piercing Shriek", description = "[q]Causes all enemies nearby to be dazed for 6 sec."},
...
[26561] = {name = "Berserker Charge", description = "[q]Charges at an enemy, knocking it back and inflicting normal damage plus 300."},
...
[26643] = {name = "Arcane Explosion", description = "[q]Sends out a blast wave of magic, inflicting Arcane damage to nearby enemies."},
...
[27556] = {name = "Rake", description = "[q]Rake the target for 200 to 300 damage and an additional 500 damage over 15 sec."},
...
[27581] = {name = "Disarm", description = "[q]Disarm the enemy's weapon for 10 sec."},
...
[27608] = {name = "Flash Heal", description = "[q]Heals a friendly target for 828 to 975."},
[27613] = {name = "Kick", description = "[q]Kicks an enemy for 2 damage, interrupting the spell being cast for 6 sec."},
[27618] = {name = "Blizzard", description = "[q]Ice shards pelt the target area doing 1192 Frost damage over 8 sec."},
[27619] = {name = "Ice Block", description = "[q]You become encased in a block of ice, protecting you from all physical attacks and spells for 10 sec, but during that time you cannot attack, move or cast spells."},
[27620] = {name = "Snap Kick", description = "[q]Kicks an enemy for 2 damage, interrupting the spell being cast for 4 sec."},
[27621] = {name = "Windfury Totem", description = "[q]Summons a Windfury Totem with 5 health at the feet of the caster. The totem enchants all party members main-hand weapons with wind, if they are within 20 yards. Each hit has a 20% chance of granting the attacker 1 extra attack with 315 extra attack power. Lasts 1.50 min."},
[27634] = {name = "Concussive Shot", description = "[q]Dazes an enemy, reducing its movement speed by 50% for 3 sec."},
[27636] = {name = "Starshards", description = "[q]Rains starshards down on the enemy target's head, causing 3000 Arcane damage over 6 sec."},
...
[27825] = {name = "Shadow Mark", description = "[q]In a whirlwind of steel you attack up to 0 enemies within 8 yards, causing weapon damage to each enemy."},
[27826] = {name = "Intercept", description = "[q]Charge an enemy, causing 25 damage and stunning it for 3 sec."},
...
[27919] = {name = "Spit", description = "[q]Shoots at an enemy, inflicting Nature damage."},
...
[28310] = {name = "Mind Flay", description = "[q]Inflicts Shadow damage to an enemy and reduces its movement speed for 8 sec."},
...
[28318] = {name = "Slime Shot", description = "[q]Shoots at an enemy, inflicting nature damage and knocking the enemy back."},
...
[28391] = {name = "Blink", description = "[q]Teleports the caster to an enemy target. Also frees the caster from any bonds."},
...
[28412] = {name = "Death Coil", description = "[q]Causes the enemy target to run in horror for 3 sec and causes 926 Shadow damage. The caster gains 100% of the damage caused in health."},
...
[28431] = {name = "Poison Charge", description = "[q]Charges an enemy and causes poison damage to all within 10 yards of the target."},
...
[28447] = {name = "Shadow Burst", description = "[q]Let forth a burst of energy knocking all nearby enemies back, dealing 240 to 360 Shadow damage and removing all threat."},
...
[29061] = {name = "Shield Wall", description = "[q]Reduces the Physical and magical damage taken by the caster by 75% for 20 sec."},
...
[29407] = {name = "Mind Flay", description = "[q]Inflicts Shadow damage to an enemy and reduces its movement speed for 10 sec."},
...
[30092] = {name = "Blast Wave", description = "[q]Unleashes a wave of flame, inflicting Fire damage to nearby enemies and reducing their movement speed for 8 sec."},
[30094] = {name = "Frost Nova", description = "[q]Inflicts Frost damage to nearby enemies, immobilizing them for up to 8 sec."},
[30095] = {name = "Cone of Cold", description = "[q]Inflicts Frost damage to enemies in a cone in front of the caster, reducing their movement speed for 8 sec."},
...
[30112] = {name = "Frenzied Dive", description = "[q]Dives upon an enemy, inflicting normal damage plus 0 and stuns the opponent for 2 sec."},
...
[30798] = {name = "Dual Wield", description = "[q]Allows one-hand and off-hand weapons to be equipped in the off-hand."},
[32309] = {name = "Slime Bolt", description = "[q]Shoots poison at an enemy, inflicting Nature damage, then additional damage every 3 sec. for 6 sec."},
